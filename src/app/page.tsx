...
export default function Home() {
  return (
    <main className="flex flex-col md:flex-row h-full md:min-h-screen  items-center justify-between w-full text-white ">
      <div className="bg-slate-950 flex flex-col justify-center items-center  w-full md:w-[50%] h-full md:h-screen ">
        {/* <Image className="object-center" src={Network} alt="network" /> */}
        <ScrollingTestimonials/>
      </div>
      <div className="w-full md:w-[50%] h-full  md:h-screen bg-[url('/cpurple-bg.png')] flex flex-col justify-center items-center brightness-75  text-3xl text-center leading-[2.9rem]  font-semibold  tracking-[.2rem] ">
